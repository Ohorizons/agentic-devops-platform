...
description: "GitHub platform integration specialist — configures GitHub Apps, org discovery, GHAS security, Actions CI/CD, and Packages for developer portals."
tools:
  - search/codebase
  - edit/editFiles
