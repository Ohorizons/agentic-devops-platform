...
The platform uses 15 Copilot Chat Agents in `.github/agents/` for interactive development assistance, plus 20 skills for specialized CLI operations. There are also 18 Terraform modules, 22 Golden Path templates, and 28 Issue templates.
